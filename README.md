...
I host this on a `glinet slate ax` you can use the cheaper $30 `glinet opal` as well if you don't need to support 50+ users. The slate is an armv7 21.02 openwrt device while the opal is mipsle 18.06, other openwrt devices will likley work if you don't mind recompiling.
